...
const NESTED_HERDR_MESSAGES: [&str; 6] = [
    ...
    "recursive momo is disabled. somewhere, a call stack breathes a sigh of relief.",
    "recursive descent denied. there is, in fact, such a thing as too much momo.",
...
const SKILL: &str = include_str!("../skills/momo/SKILL.md");
