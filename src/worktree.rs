...
";
    ...
    fn expand_tilde_path_uses_home_when_available() {
        assert_eq!(
            expand_tilde_path_from_env("~/.momo/worktrees", false, |key| match key {
                "HOME" => Some("/home/me".into()),
                _ => None,
            }),
            PathBuf::from("/home/me/.momo/worktrees")
        );
        assert_eq!(
    ...
    fn windows_tilde_expansion_normalizes_separators() {
        ...
        let default_path = expand_tilde_path_from_env("~/.momo/worktrees", true, env);
        assert_eq!(
            default_path,
    ...
    fn default_checkout_path_appends_repo_and_branch_slug() {
        assert_eq!(
            default_checkout_path(
                Path::new("/home/me/.momo/worktrees"),
                "herdr",
                "worktree/brave-river",
            ),
            PathBuf::from("/home/me/.momo/worktrees/herdr/worktree-brave-river")
        );
    }
